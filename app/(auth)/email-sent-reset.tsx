...
export default function EmailSent() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/*
<TouchableOpacity style={styles.backButton} onPress={() => navigate.toForgotPassword()}>
...
*/}
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Check your email for reset code</Text>
        </View>
        ...
        <View style={styles.emailIconContainer}>
          ...
          <View style={styles.emailInfoContainer}>
            <Text style={styles.emailSentText}>Reset code sent to</Text>
        ...
        <View style={styles.formContainer}>
          <View style={styles.formCard}>
            ...
            <Text style={styles.formDescription}>
              We've sent a 6-digit reset code to your email address. Please
            ...
            <TouchableOpacity
              style={[
                styles.verifyButton,
                (isSubmitting || !otp) && styles.verifyButtonDisabled,
              ]}
